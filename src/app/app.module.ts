...
@NgModule({
  declarations: [AppComponent, UsersContainerComponent, UsersListComponent, UsersListItemComponent, TodosContainerComponent, TodosListComponent, TodosListItemComponent, LoaderComponent],
